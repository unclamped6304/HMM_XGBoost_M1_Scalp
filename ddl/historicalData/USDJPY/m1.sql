...
CREATE INDEX idx_usdjpy_m1_date ON usdjpy_m1 (date);
COMMENT ON TABLE usdjpy_m1 IS '1-minute OHLC bar data. Timezone: GMT+2 with US DST applied. Source: Dukascopy export from Tick Data Suite.';
