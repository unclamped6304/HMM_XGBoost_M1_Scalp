...
CREATE INDEX idx_eurusd_d1_date ON eurusd_d1 (date);
COMMENT ON TABLE eurusd_d1 IS '1-day OHLC bar data. Timezone: GMT+2 with US DST applied. Source: Dukascopy export from Tick Data Suite.';
