...
CREATE INDEX idx_eurusd_m1_date ON eurusd_m1 (date);
COMMENT ON TABLE eurusd_m1 IS '1-minute OHLC bar data. Timezone: GMT+2 with US DST applied. Source: Dukascopy export from Tick Data Suite.';
