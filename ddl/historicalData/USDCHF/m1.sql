...
CREATE INDEX idx_usdchf_m1_date ON usdchf_m1 (date);
COMMENT ON TABLE usdchf_m1 IS '1-minute OHLC bar data. Timezone: GMT+2 with US DST applied. Source: Dukascopy export from Tick Data Suite.';
